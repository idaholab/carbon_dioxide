...
//
SBTLAPI double __stdcall SIGMA_TS_CO2(double t) throw()
{
    static const double tc=304.128;         //as used in fit by Mulero et al.
    static const double sigma0=0.07863e3;   //unit: mN/m
    static const double n=1.254;

    double tau=1.-t/tc;

    return sigma0*pow(tau,n);
}
//
